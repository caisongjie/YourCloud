...
public class Constant {
	...
	public final static int[][] USR_TYPE_OWNED = { { 0, 1, 2,3 } };
	// The Amount of the VM broker has
	public final static int[][] USR_VMNUM_OWNED = { { 15, 15, 15, 15 } };
	// The Types of the Cloudlets broker has (starts from 0)
	public final static int[][] USR_CLOUDLET_TYPE = { { 3,2, 1, 0 }};
...
//	public final static int[] CLOUD_ALLOCATION = { 2,2,2,2 };
	...
	public final static double[] HOST_MIN_UTIL = { 0.3, 0.3, 0.3, 0.3, 0.3 };//this is minimum mips for minimum power
	...
	public final static double STEP_INTERVAL = 10;
	public final static double SCALEX = 60*60;
	public final static double MAXPOWERS = 162;
