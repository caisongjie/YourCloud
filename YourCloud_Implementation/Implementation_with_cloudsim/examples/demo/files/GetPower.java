...
import demo.Main;
import demo.createSimulation.DatacenterCreate;
import demo.createSimulation.GlobalBroker;
import demo.extras.PowerDatacenterExtra;
import demo.vmSchedulers.DVFS;
...
public class GetPower {
	...
	private ArrayList<GlobalBroker> glBrokerList = new ArrayList<GlobalBroker>();;
	private double datacenterPower;
	private PowerMonitor monitor;
	private static String allocName;

	public GetPower(String allocator, int logOutput,
		...
		try {
			...
			if (allocator != "NPA") {
				...
				for (GlobalBroker glBroker : glBrokerList) {
